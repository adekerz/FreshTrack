...
export default function MarshaCodesPage() {
                      ...
                      <td className="px-4 py-3 text-center">
                        {code.isAssigned ? (
                          <button
                            ...
                            className={cn(
                              'p-1.5 rounded-lg hover:bg-red-100 text-red-600 dark:hover:bg-red-900/30 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center mx-auto',
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg hover:bg-green-100 text-green-600 dark:hover:bg-green-900/30 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center mx-auto"
                  ...
                  <div className="flex justify-end">
                    {code.isAssigned ? (
                      <button
                        ...
                        disabled={releasing === code.id}
                        className={cn(
                          'px-3 py-1.5 rounded-lg text-sm bg-red-100 text-red-700 hover:bg-red-200 dark:bg-red-900/30 dark:hover:bg-red-900/50 transition-colors min-h-[44px]',
                          releasing === code.id && 'opacity-50 cursor-not-allowed'
                        )}
                      >
                        {releasing === code.id ? (
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg text-sm bg-green-100 text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:hover:bg-green-900/50 transition-colors min-h-[44px]"
                      >
