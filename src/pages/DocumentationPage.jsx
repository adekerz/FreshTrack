  ...
  const sections = [
    {
      ...
      content: t(
        ...
        'Добро пожаловать в FreshTrack. Система предназначена для управления инвентарем и сроками годности продуктов в отелях. Начните с создания отделов и настройки пользователей.'
      ),
    },
    {
      id: 'inventory',
      ...
      content: t(
        'docs.inventory.content',
        'Инвентарь разделен по отделам. Используйте сканер штрих-кодов или ручной вводите данные о товарах. Следите за цветовыми индикаторами сроков годности (зеленый - ок, желтый - внимание, красный - критично).'
      ),
    },
    {
      id: 'reports',
      ...
      content: t(
        ...
        'Вы можете экспортировать данные в Excel, PDF или CSV форматы. Экспорт доступен в разделе "Статистика" и "Инвентарь".'
      ),
    },
    {
      id: 'security',
      ...
      content: t(
        ...
        'Для защиты аккаунта включите двухфакторную аутентификацию (MFA/TOTP). Используйте Google Authenticator или Authy для генерации кодов.'
      ),
    },
    {
      id: 'hotkeys',
      ...
      content: t(
        'docs.hotkeys.content',
        'Ctrl+K (Поиск), Ctrl+N (Новый товар), Ctrl+E (Экспорт), Esc (Закрыть). Полный список доступен в Центре помощи (?).'
      ),
    },
  ]
